		...
		<div class="main">
			...
			<div id="contents">
				...
				<div class="board_count">
					<div class="ctn">
						<span>총</span> <strong>${total}</strong> <span>건</span>
					</div>
				</div>
				<div class="board_normal_list">
					<ul>
						<c:forEach var="vo" items="${voList}">
							<li><a href="/museum/donationlist_view?seq=${vo.seq}">
									<div class="title_line">${vo.title}</div>
									<div class="info_line">
										<span>번호 : ${vo.seq}</span> <span>자료번호 : ${vo.data_num}</span>
										<span>기증일 : ${vo.dona_date}</span>
									</div>
							</a></li>
						</c:forEach>
				...
				<c:if test="${member.user.equals('admin')}">
					<div class="list_write">
						<a class="btn txtc" href="/museum/donationlist_write">글쓰기</a>
					</div>				
				</c:if>
				<div class="board_paging">
					...
					<ul class="num_btns">
						<c:forEach var="i" begin="${mapper.groupStart}" end="${mapper.groupEnd}">						

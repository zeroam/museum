...
<ul id="lnb_ul">
		...
		<ul id="lnb_cate">
			<li class="${index == 1 ? 'active': ''}"><a>자료기증</a>
				<ul>
					...
					<li class="${cate == 'donationlist' ? 'active' : ''}"><a href="/museum/donationlist">기증 내역</a></li>
				</ul></li>
			<li class="${index == 2 ? 'active': ''}"><a>자료실</a>
				<ul>
					<li class="${cate == 'collectionlist' ? 'active' : ''}"><a href="/museum/collectionlist">소장 자료 검색</a></li>
	...
	<li class="${content == 'news' ? 'active': ''}"><a href="/museum/news"> <span>소식</span>
	</a>
		<ul id="lnb_cate">
			<li class="${cate == 'news' ? 'active' : ''}"><a href="/museum/news">새 소식</a></li>
			<li class="${cate == 'event' ? 'active' : ''}"><a href="/museum/event">문화행사</a></li>
